...
class ImageReward(nn.Module):
    def __init__(self, med_config, device='cpu',bert_pretrained_model_name_or_path='bert-base-uncased'):
        super().__init__()
        self.device = device
        
        self.blip = BLIP_Pretrain(image_size=224, 
                                  vit='large', 
                                  med_config=med_config,
                                  bert_pretrained_model_name_or_path=bert_pretrained_model_name_or_path)
